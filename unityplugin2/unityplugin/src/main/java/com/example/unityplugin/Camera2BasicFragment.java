...
public class Camera2BasicFragment extends Fragment
    ...
    // unity에 image buffer를 넘기기 위해 추가함
    ...
    public void onResume() {
        ...
        Intent Uplugin = new Intent(getActivity(), Unity.class);
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // 이거 JPG에서 YUV로 변경함
                mImageReader = ImageReader.newInstance(largest.getWidth(), largest.getHeight(), ImageFormat.YUV_420_888, /*maxImages*/3);
    ...
    private void openCamera(int width, int height) {
        ...
        // 유니티에 값전달하기 위해 추가
        m_unity.set_texture_width(width);
        m_unity.set_texture_height(height);
        m_unity.start_cam();
        //
